...
this.chatTpl=i.html(),i.remove(),this.$el.addClass(this.type)
var a=t(document.body)
a.find(".ah-chat").remove(),a.append(this.el),this.delegateEvents(),s.resolve()}},this)),s.promise()},this.get=function(t,e,s){var n=new XMLHttpRequest
